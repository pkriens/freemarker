...
TemplateElement root = children.asSingleElement();
  ...
  private boolean jj_2_17(int xla)
 {
  ...
  private boolean jj_3R_AtomicExpression_1708_9_66()
 {
    if (jj_3R_StringLiteral_2464_5_81()) return true;
    return false;
  }

  private boolean jj_3R_AtomicExpression_1706_9_65()
 {
    if (jj_3R_HashLiteral_2530_5_80()) return true;
    return false;
  }
  ...
  private boolean jj_3_12()
 {
  ...
  private boolean jj_3R_AtomicExpression_1704_9_64()
 {
    if (jj_3R_NumberLiteral_2063_5_79()) return true;
    return false;
  }

  private boolean jj_3R_BuiltIn_2276_9_102()
 {
    if (jj_3R_MethodArgs_2447_9_88()) return true;
    return false;
  }

  private boolean jj_3R_StringLiteral_2467_9_95()
 {
    if (jj_scan_token(RAW_STRING)) return true;
    return false;
  }

  private boolean jj_3R_AtomicExpression_1703_5_60()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_AtomicExpression_1704_9_64()) {
    jj_scanpos = xsp;
    if (jj_3R_AtomicExpression_1706_9_65()) {
    jj_scanpos = xsp;
    if (jj_3R_AtomicExpression_1708_9_66()) {
    jj_scanpos = xsp;
    if (jj_3R_AtomicExpression_1710_9_67()) {
    jj_scanpos = xsp;
    if (jj_3R_AtomicExpression_1712_9_68()) {
    jj_scanpos = xsp;
    if (jj_3R_AtomicExpression_1714_9_69()) {
    jj_scanpos = xsp;
    if (jj_3R_AtomicExpression_1716_9_70()) {
    jj_scanpos = xsp;
    if (jj_3R_AtomicExpression_1718_9_71()) return true;
    }
    }
    }
    }
  ...
  private boolean jj_3R_EqualityExpression_1887_9_57()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_scan_token(107)) {
    ...
    if (jj_3R_RelationalExpression_1916_5_56()) return true;
    return false;
  }

  private boolean jj_3R_Identifier_2082_5_43()
 {
    if (jj_scan_token(ID)) return true;
    return false;
  }

  private boolean jj_3R_StringLiteral_2464_5_81()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_scan_token(93)) {
    jj_scanpos = xsp;
    if (jj_3R_StringLiteral_2467_9_95()) return true;
    }
    return false;
  }

  private boolean jj_3R_EqualityExpression_1885_5_50()
 {
    if (jj_3R_RelationalExpression_1916_5_56()) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_EqualityExpression_1887_9_57()) jj_scanpos = xsp;
    return false;
  }

  private boolean jj_3R_BuiltIn_2262_9_101()
 {
    if (jj_scan_token(OPEN_PAREN)) return true;
    if (jj_3R_PositionalMaybeLambdaArgs_3773_5_109()) return true;
    if (jj_scan_token(CLOSE_PAREN)) return true;
    return false;
  }

  private boolean jj_3R_PrimaryExpression_1686_9_77()
 {
    if (jj_3R_Exists_2174_5_91()) return true;
    return false;
  }

  private boolean jj_3R_PrimaryExpression_1684_9_76()
 {
    if (jj_3R_DefaultTo_2146_5_90()) return true;
    return false;
  }

  private boolean jj_3R_MethodArgs_2447_9_88()
 {
    if (jj_scan_token(OPEN_PAREN)) return true;
    if (jj_3R_PositionalArgs_3751_5_98()) return true;
    if (jj_scan_token(CLOSE_PAREN)) return true;
    return false;
  }

  private boolean jj_3R_PrimaryExpression_1682_9_75()
 {
    if (jj_3R_BuiltIn_2192_5_89()) return true;
    return false;
  }

  private boolean jj_3R_PrimaryExpression_1680_9_74()
 {
    if (jj_3R_MethodArgs_2447_9_88()) return true;
    return false;
  }

  private boolean jj_3R_PositionalMaybeLambdaArgs_3776_13_114()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_scan_token(130)) jj_scanpos = xsp;
    if (jj_3R_LocalLambdaExpression_2303_5_113()) return true;
    return false;
  }

  private boolean jj_3R_PrimaryExpression_1678_9_73()
 {
    if (jj_3R_DynamicKey_2426_5_87()) return true;
    return false;
  }

  private boolean jj_3R_MultiplicativeExpression_1861_17_49()
 {
    if (jj_scan_token(PERCENT)) return true;
    return false;
  }

  private boolean jj_3R_NumberLiteral_2063_5_79()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_scan_token(97)) {
  ...
  private boolean jj_3R_PrimaryExpression_1676_9_61()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_PrimaryExpression_1676_9_72()) {
    jj_scanpos = xsp;
    if (jj_3R_PrimaryExpression_1678_9_73()) {
    jj_scanpos = xsp;
    if (jj_3R_PrimaryExpression_1680_9_74()) {
    jj_scanpos = xsp;
    if (jj_3R_PrimaryExpression_1682_9_75()) {
    jj_scanpos = xsp;
    if (jj_3R_PrimaryExpression_1684_9_76()) {
    jj_scanpos = xsp;
    if (jj_3R_PrimaryExpression_1686_9_77()) return true;
    }
    }
    }
    }
  ...
  private boolean jj_3R_PrimaryExpression_1676_9_72()
 {
    if (jj_3R_DotVariable_2377_9_86()) return true;
    return false;
  }

  private boolean jj_3R_MultiplicativeExpression_1859_17_48()
 {
    if (jj_scan_token(DIVIDE)) return true;
    return false;
  }

  private boolean jj_3R_MultiplicativeExpression_1857_17_47()
 {
    if (jj_scan_token(TIMES)) return true;
    return false;
  }

  private boolean jj_3R_PositionalMaybeLambdaArgs_3774_9_112()
 {
    if (jj_3R_LocalLambdaExpression_2303_5_113()) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_PositionalMaybeLambdaArgs_3776_13_114()) { jj_scanpos = xsp; break; }
    }
    return false;
  }

  private boolean jj_3R_BuiltIn_2246_9_100()
 {
    if (jj_scan_token(OPEN_PAREN)) return true;
    if (jj_3R_PositionalArgs_3751_5_98()) return true;
    if (jj_scan_token(CLOSE_PAREN)) return true;
  ...
  private boolean jj_3_17()
 {
  ...
  private boolean jj_3R_PrimaryExpression_1674_5_55()
 {
    if (jj_3R_AtomicExpression_1703_5_60()) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_PrimaryExpression_1676_9_61()) { jj_scanpos = xsp; break; }
    }
    return false;
  }

  private boolean jj_3R_PositionalMaybeLambdaArgs_3773_5_109()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_PositionalMaybeLambdaArgs_3774_9_112()) jj_scanpos = xsp;
    return false;
  }

  private boolean jj_3R_MultiplicativeExpression_1854_9_37()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_MultiplicativeExpression_1857_17_47()) {
    jj_scanpos = xsp;
    if (jj_3R_MultiplicativeExpression_1859_17_48()) {
    jj_scanpos = xsp;
    if (jj_3R_MultiplicativeExpression_1861_17_49()) return true;
    }
    }
    if (jj_3R_UnaryExpression_1752_5_36()) return true;
    return false;
  }

  private boolean jj_3R_ListLiteral_2048_5_83()
 {
  ...
  private boolean jj_3R_DynamicKey_2426_5_87()
 {
    if (jj_scan_token(OPEN_BRACKET)) return true;
    if (jj_3R_Expression_1658_5_29()) return true;
    if (jj_scan_token(CLOSE_BRACKET)) return true;
    return false;
  }

  private boolean jj_3R_PositionalArgs_3754_13_111()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_scan_token(130)) jj_scanpos = xsp;
  ...
  private boolean jj_3R_MultiplicativeExpression_1852_5_31()
 {
    if (jj_3R_UnaryExpression_1752_5_36()) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_MultiplicativeExpression_1854_9_37()) { jj_scanpos = xsp; break; }
    }
    return false;
  }

  private boolean jj_3R_Expression_1658_5_29()
 {
    if (jj_3R_OrExpression_2024_5_33()) return true;
    return false;
  }
  ...
  private boolean jj_3_7()
 {
  ...
  private boolean jj_3R_PositionalArgs_3752_9_108()
 {
    if (jj_3R_Expression_1658_5_29()) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_PositionalArgs_3754_13_111()) { jj_scanpos = xsp; break; }
    }
    return false;
  }

  private boolean jj_3R_PositionalArgs_3751_5_98()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_PositionalArgs_3752_9_108()) jj_scanpos = xsp;
    return false;
  }

  private boolean jj_3R_OrExpression_2026_9_41()
 {
    if (jj_scan_token(OR)) return true;
    if (jj_3R_AndExpression_2001_5_40()) return true;
    return false;
  }
  ...
  private boolean jj_3_15()
 {
  ...
  private boolean jj_3R_OrExpression_2024_5_33()
 {
    if (jj_3R_AndExpression_2001_5_40()) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_OrExpression_2026_9_41()) { jj_scanpos = xsp; break; }
    }
    return false;
  }

  private boolean jj_3R_AdditiveExpression_1819_17_39()
 {
    if (jj_scan_token(MINUS)) return true;
    return false;
  }

  private boolean jj_3R_AdditiveExpression_1817_17_38()
 {
  ...
  private boolean jj_3_6()
 {
  ...
  private boolean jj_3R_AdditiveExpression_1814_9_32()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_AdditiveExpression_1817_17_38()) {
    jj_scanpos = xsp;
    if (jj_3R_AdditiveExpression_1819_17_39()) return true;
    }
    if (jj_3R_MultiplicativeExpression_1852_5_31()) return true;
    return false;
  }

  private boolean jj_3R_DotVariable_2381_13_99()
 {
    Token xsp;
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_AndExpression_2003_9_51()
 {
    if (jj_scan_token(AND)) return true;
    if (jj_3R_EqualityExpression_1885_5_50()) return true;
    return false;
  }

  private boolean jj_3R_AdditiveExpression_1812_5_28()
 {
    if (jj_3R_MultiplicativeExpression_1852_5_31()) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_AdditiveExpression_1814_9_32()) { jj_scanpos = xsp; break; }
    }
    return false;
  }

  private boolean jj_3R_BuiltIn_2192_5_89()
 {
    if (jj_scan_token(BUILT_IN)) return true;
    if (jj_scan_token(ID)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_BuiltIn_2246_9_100()) jj_scanpos = xsp;
    xsp = jj_scanpos;
    if (jj_3R_BuiltIn_2262_9_101()) jj_scanpos = xsp;
    xsp = jj_scanpos;
    if (jj_3R_BuiltIn_2276_9_102()) jj_scanpos = xsp;
    return false;
  }

  private boolean jj_3R_AndExpression_2001_5_40()
 {
    if (jj_3R_EqualityExpression_1885_5_50()) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_AndExpression_2003_9_51()) { jj_scanpos = xsp; break; }
    }
    return false;
  }

  private boolean jj_3R_DotVariable_2377_9_86()
 {
    ...
    jj_scanpos = xsp;
    if (jj_3R_DotVariable_2381_13_99()) return true;
    }
    }
    }
    return false;
 ...
 {
    if (jj_3R_AdditiveExpression_1812_5_28()) return true;
    return false;
  }

  private boolean jj_3R_UnaryPlusMinusExpression_1796_9_58()
 {
    if (jj_scan_token(MINUS)) return true;
    return false;
  }
  ...
  private boolean jj_3_14()
 {
  ...
  private boolean jj_3R_RangeExpression_1968_21_106()
 {
    if (jj_3R_AdditiveExpression_1812_5_28()) return true;
    return false;
  }

  private boolean jj_3R_UnaryPlusMinusExpression_1793_5_53()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_scan_token(120)) {
    jj_scanpos = xsp;
    if (jj_3R_UnaryPlusMinusExpression_1796_9_58()) return true;
    }
    if (jj_3R_PrimaryExpression_1674_5_55()) return true;
    return false;
  }

  private boolean jj_3R_Exists_2174_5_91()
 {
  ...
  private boolean jj_3_8()
 {
  ...
  private boolean jj_3R_LambdaExpressionParameterList_2346_21_52()
 {
    if (jj_scan_token(COMMA)) return true;
    if (jj_3R_Identifier_2082_5_43()) return true;
    return false;
  }

  private boolean jj_3R_LambdaExpressionParameterList_2356_9_35()
 {
    if (jj_3R_Identifier_2082_5_43()) return true;
    return false;
  }

  private boolean jj_3R_HashLiteral_2541_13_107()
 {
    if (jj_scan_token(COMMA)) return true;
    if (jj_3R_Expression_1658_5_29()) return true;
    Token xsp;
  ...
  private boolean jj_3R_RangeExpression_1960_21_105()
 {
    if (jj_scan_token(DOT_DOT_ASTERISK)) return true;
    return false;
  }

  private boolean jj_3R_RangeExpression_1958_21_104()
 {
    if (jj_scan_token(DOT_DOT_LESS)) return true;
    return false;
  }

  private boolean jj_3R_DefaultTo_2152_17_110()
 {
    if (jj_3R_Expression_1658_5_29()) return true;
    return false;
  }

  private boolean jj_3R_RangeExpression_1965_13_93()
 {
    if (jj_scan_token(DOT_DOT)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_RangeExpression_1968_21_106()) jj_scanpos = xsp;
    return false;
  }

  private boolean jj_3R_LambdaExpressionParameterList_2340_17_42()
 {
    if (jj_3R_Identifier_2082_5_43()) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_LambdaExpressionParameterList_2346_21_52()) { jj_scanpos = xsp; break; }
    }
    return false;
  }

  private boolean jj_3R_NotExpression_1772_9_59()
 {
    if (jj_scan_token(EXCLAM)) return true;
    return false;
  }

  private boolean jj_3R_RangeExpression_1956_13_92()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_RangeExpression_1958_21_104()) {
    jj_scanpos = xsp;
    if (jj_3R_RangeExpression_1960_21_105()) return true;
    }
    if (jj_3R_AdditiveExpression_1812_5_28()) return true;
    return false;
  }

  private boolean jj_3R_HashLiteral_2532_9_94()
 {
    if (jj_3R_Expression_1658_5_29()) return true;
    Token xsp;
    xsp = jj_scanpos;
    ...
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_HashLiteral_2541_13_107()) { jj_scanpos = xsp; break; }
    }
    return false;
  }

  private boolean jj_3R_DefaultTo_2149_9_103()
 {
    if (jj_scan_token(EXCLAM)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_DefaultTo_2152_17_110()) jj_scanpos = xsp;
    return false;
  }

  private boolean jj_3R_NotExpression_1771_5_54()
 {
    Token xsp;
    if (jj_3R_NotExpression_1772_9_59()) return true;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_NotExpression_1772_9_59()) { jj_scanpos = xsp; break; }
    }
    if (jj_3R_PrimaryExpression_1674_5_55()) return true;
    return false;
  }

  private boolean jj_3R_LambdaExpressionParameterList_2337_9_34()
 {
    if (jj_scan_token(OPEN_PAREN)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_LambdaExpressionParameterList_2340_17_42()) jj_scanpos = xsp;
    if (jj_scan_token(CLOSE_PAREN)) return true;
    return false;
  }

  private boolean jj_3R_RangeExpression_1954_9_78()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_RangeExpression_1956_13_92()) {
    jj_scanpos = xsp;
    if (jj_3R_RangeExpression_1965_13_93()) return true;
    }
    return false;
  }

  private boolean jj_3R_HashLiteral_2530_5_80()
 {
    if (jj_scan_token(OPENING_CURLY_BRACKET)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_HashLiteral_2532_9_94()) jj_scanpos = xsp;
    if (jj_scan_token(CLOSING_CURLY_BRACKET)) return true;
    return false;
  }

  private boolean jj_3R_DefaultTo_2146_5_90()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_scan_token(153)) {
    jj_scanpos = xsp;
    if (jj_3R_DefaultTo_2149_9_103()) return true;
    }
    return false;
  }

  private boolean jj_3R_LambdaExpressionParameterList_2336_5_30()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_LambdaExpressionParameterList_2337_9_34()) {
    jj_scanpos = xsp;
    if (jj_3R_LambdaExpressionParameterList_2356_9_35()) return true;
    }
    return false;
  }

  private boolean jj_3R_UnaryExpression_1757_9_46()
 {
    if (jj_3R_PrimaryExpression_1674_5_55()) return true;
    return false;
  }

  private boolean jj_3R_RangeExpression_1952_5_62()
 {
    if (jj_3R_AdditiveExpression_1812_5_28()) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_RangeExpression_1954_9_78()) jj_scanpos = xsp;
    return false;
  }

  private boolean jj_3R_UnaryExpression_1755_9_45()
 {
    if (jj_3R_NotExpression_1771_5_54()) return true;
    return false;
  }
  ...
  private boolean jj_3_11()
 {
  ...
  private boolean jj_3R_UnaryExpression_1753_9_44()
 {
    if (jj_3R_UnaryPlusMinusExpression_1793_5_53()) return true;
    return false;
  }

  private boolean jj_3R_BooleanLiteral_2513_9_97()
 {
    if (jj_scan_token(TRUE)) return true;
    return false;
  }

  private boolean jj_3R_LocalLambdaExpression_2321_9_116()
 {
    if (jj_3R_OrExpression_2024_5_33()) return true;
    return false;
  }

  private boolean jj_3R_UnaryExpression_1752_5_36()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_UnaryExpression_1753_9_44()) {
    jj_scanpos = xsp;
    if (jj_3R_UnaryExpression_1755_9_45()) {
    jj_scanpos = xsp;
    if (jj_3R_UnaryExpression_1757_9_46()) return true;
    }
    }
    return false;
  }

  private boolean jj_3R_BooleanLiteral_2511_9_96()
 {
    if (jj_scan_token(FALSE)) return true;
    return false;
  }

  private boolean jj_3R_BooleanLiteral_2510_5_82()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_BooleanLiteral_2511_9_96()) {
    jj_scanpos = xsp;
    if (jj_3R_BooleanLiteral_2513_9_97()) return true;
    }
    return false;
  }
 ...
 {
    if (jj_3R_LambdaExpressionParameterList_2336_5_30()) return true;
  ...
  private boolean jj_3_4()
 {
  ...
  private boolean jj_3R_LocalLambdaExpression_2304_9_115()
 {
    if (jj_3R_LambdaExpressionParameterList_2336_5_30()) return true;
    if (jj_scan_token(LAMBDA_ARROW)) return true;
    if (jj_3R_OrExpression_2024_5_33()) return true;
  ...
  private boolean jj_3R_Parenthesis_1731_5_84()
 {
    if (jj_scan_token(OPEN_PAREN)) return true;
    if (jj_3R_Expression_1658_5_29()) return true;
    if (jj_scan_token(CLOSE_PAREN)) return true;
  ...
  private boolean jj_3R_RelationalExpression_1918_9_63()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_scan_token(151)) {
    ...
    if (jj_3R_RangeExpression_1952_5_62()) return true;
    return false;
  }

  private boolean jj_3R_LocalLambdaExpression_2303_5_113()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_LocalLambdaExpression_2304_9_115()) {
    jj_scanpos = xsp;
    if (jj_3R_LocalLambdaExpression_2321_9_116()) return true;
    }
    return false;
  }

  private boolean jj_3R_BuiltinVariable_2110_5_85()
 {
    if (jj_scan_token(DOT)) return true;
    if (jj_scan_token(ID)) return true;
    return false;
  ...
  private boolean jj_3R_RelationalExpression_1916_5_56()
 {
    if (jj_3R_RangeExpression_1952_5_62()) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_RelationalExpression_1918_9_63()) jj_scanpos = xsp;
    return false;
  }

  private boolean jj_3R_AtomicExpression_1718_9_71()
 {
    if (jj_3R_BuiltinVariable_2110_5_85()) return true;
    return false;
  }

  private boolean jj_3R_AtomicExpression_1716_9_70()
 {
    if (jj_3R_Parenthesis_1731_5_84()) return true;
    return false;
  }

  private boolean jj_3R_AtomicExpression_1714_9_69()
 {
    if (jj_3R_Identifier_2082_5_43()) return true;
    return false;
  }
  ...
  private boolean jj_3_9()
 {
  ...
  private boolean jj_3R_AtomicExpression_1712_9_68()
 {
    if (jj_3R_ListLiteral_2048_5_83()) return true;
    return false;
  }

  private boolean jj_3R_AtomicExpression_1710_9_67()
 {
    if (jj_3R_BooleanLiteral_2510_5_82()) return true;
    return false;
  }
